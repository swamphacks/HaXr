...
export default function Section({
	...
	const { form, _, errors, setErrors, ...args } = useContext(FormCreatorContext);
	...
	return (
		...
		>
			<Accordion.Control
				styles={{ label: { color: errorInSection ? 'var(--mantine-color-red-6)' : 'inherit' } }}
			>{section.title}</Accordion.Control>
			<Accordion.Panel>
				<Stack align='center'>
					<TextInput
